...
export function AdminSettings() {
  ...
  return (
    <div className="space-y-8">
      ...
      <Section
        title="Voice loop"
        hint="Controlli del riconoscimento vocale e della sintesi. Per personalizzare i parametri di una specifica voce (stability, similarity, style, speed) vai in Voci e clicca ⚙ sulla card della voce."
      >
