...
export default defineConfig({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        // `id` is REQUIRED on Android 14+ for the WebAPK to install
        // without the Chrome browser badge over the icon. Pinning it
        // to the start_url keeps the same identity across updates so
        // the OS doesn't reinstall a "different" app.
        id: '/?source=pwa',
